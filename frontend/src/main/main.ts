...
function canvasApp() {
    ...
    var theCanvas = document.getElementById("canvasOne") as HTMLCanvasElement;
    ...
    var wait:number;
    var count:number;
    var numToAddEachFrame:number;
    var particleList:{first?:any};
    var recycleBin:{first?: any};
    var particleAlpha:number;
    var r,g,b;
    var fLen:number;
    var m;
    var projCenterX:number;
    var projCenterY:number;
    var zMax:number;
    var turnAngle:number;
    var turnSpeed:number;
    var sphereRad:number, sphereCenterX, sphereCenterY:number, sphereCenterZ:number;
    var particleRad:number;
    var zeroAlphaDepth:number;
    var randAccelX:number, randAccelY:number, randAccelZ:number;
    var gravity:number;
